	...
	<div class="container">
		<div class="row">
			<?php foreach ($services as $k => $item): ?>
				<div class="col-sm-4 services__col-<?php echo ++$k; ?>">
					<div class="services__item">
						<div class="services__icon"><i class="<?php echo $item[icon]; ?>"></i></div>
						<div class="services__title"><?php echo $item[title]; ?></div>
						<div class="services__text"><?php echo $item[text]; ?></div>
					</div>
				</div>
			<?php endforeach; ?>
		</div>
