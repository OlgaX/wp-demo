...
<section class="top-slider">
		<ul id="top_slider" class="top-slider__container">
			<?php foreach ($top_block as $k => $item) : ?>
				<li class="top-slider__slide top-slider__slide-<?php echo ++$k; ?>">
						<div class="container">
							<div class="top-slider__content">
								<div class="top-slider__title"><?php echo $item[title]; ?></div>
								<div class="top-slider__text"><?php echo $item[text]; ?></div>
							</div>
