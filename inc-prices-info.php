		...
		<div class="row">
			<?php foreach ($prices as $k => $item): ?>
				<div class="col-md-3 col-sm-6">
					<div class="prices-info__item">
						<div class="prices-info__icon"><i class="<?php echo $item[icon]; ?>"></i></div>
						<div class="prices-info__title"><?php echo $item[title]; ?></div>
						<div class="prices-info__text"><?php echo $item[text]; ?></div>
					</div>
				</div>
			<?php endforeach; ?>
		</div>
