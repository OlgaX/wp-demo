		...
		<div class="guarantees-list">
			<?php
				...
				<?php if ($new_row) : ?><div class="row"><?php endif;?>
					...
					<?php if ($k === 1) : ?>
						<div class="col-sm-6">
							<div class="guarantees-list__block-title"><?php echo $item[block_title]; ?></div>
						</div>
					<?php else : ?>

					<div class="col-sm-6">
						<div class="guarantees-list__item">
							<div class="guarantees-list__icon"><i class="<?php echo $item[icon]; ?>"></i></div>
							<div class="guarantees-list__desc">
								<div class="guarantees-list__title"><?php echo $item[title]; ?></div>
								<div class="guarantees-list__text"><?php echo $item[text]; ?></div>
							</div>
						</div>
					</div>
