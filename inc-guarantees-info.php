	...
	<div class="container">
		<div class="row">
			<?php foreach ($guarantees as $k => $item): ?>
				<div class="col-sm-3">
					<div class="guarantees-info__item">
						<div class="guarantees-info__icon"><i class="<?php echo $item[icon]; ?>"></i></div>
						<div class="guarantees-info__title"><?php echo $item[title]; ?></div>
						<div class="guarantees-info__text"><?php echo $item[text]; ?></div>
					</div>
				</div>
			<?php endforeach; ?>
		</div>
